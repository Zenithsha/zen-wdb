...
export interface ApiAnnouncementAnnouncement
  ...
  info: {
    description: 'Site-wide messages from admins, surfaced on the homepage hero.';
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles written by bloggers';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    adminFeedback: Schema.Attribute.Text;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Article comments with nested reply support';
    displayName: 'Comment';
    pluralName: 'comments';
...
export interface ApiNewsletterSignupNewsletterSignup
  ...
  info: {
    description: 'Public email sign-ups for the xBlog newsletter.';
...
export interface ApiNotificationNotification
  ...
  info: {
    description: 'Per-user notifications: comments, reactions, mentions, post approvals/rejections, etc.';
...
export interface ApiReactionReaction extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Article reactions (like, love, fire, insightful)';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['like', 'love', 'fire', 'insightful']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSubscriptionSubscription
  ...
  info: {
    description: 'Email subscriptions for weekly digest or specific tags';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subscriptionType: Schema.Attribute.Enumeration<['weekly_digest', 'tag']> &
      Schema.Attribute.Required;
